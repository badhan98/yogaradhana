        ...
        <div style={{
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '12px', paddingTop: '1rem' }}>
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/yogaradhana_by_paulami"
                target="_blank"
                rel="noopener noreferrer"
                title="Instagram"
                style={{
                  ...
                  borderRadius: '50%',
                  border: '2px solid rgba(27,45,42,0.15)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  cursor: 'pointer',
                  transition: 'all 0.3s',
                  textDecoration: 'none',
                ...
                onMouseLeave={e => {
                  ...
                  e.currentTarget.style.borderColor = 'rgba(27,45,42,0.15)';
                }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1B2D2A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <rect x="2" y="2" width="20" height="20" rx="5" ry="5"/>
                  <circle cx="12" cy="12" r="4"/>
                  <circle cx="17.5" cy="6.5" r="1" fill="#1B2D2A" strokeWidth="0"/>
                </svg>
              </a>

              {/* Facebook */}
              <a
                href="https://www.facebook.com/yogaradhana"
                target="_blank"
                rel="noopener noreferrer"
                title="Facebook"
                style={{
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#1B2D2A">
              ...
              {/* YouTube */}
              <a
                href="https://www.youtube.com/@yogaradhana"
                target="_blank"
                rel="noopener noreferrer"
                title="YouTube"
                style={{
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="#1B2D2A">
